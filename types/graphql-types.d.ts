...
export type ContentfulBlogFieldsEnum = 
  ...
  | 'thumbnail___localFile___publicURL'
  | 'thumbnail___localFile___childImageSharp___id'
  | 'thumbnail___localFile___childImageSharp___children'
  ...
  | 'childContentfulBlogBodyTextNode___childMarkdownRemark___headings___id'
...
export type SitePageFieldsEnum = 
  ...
  | 'pluginCreator___pluginOptions___resources'
...
export type SitePluginPluginOptionsFilterInput = {
  ...
  resources?: Maybe<StringQueryOperatorInput>;
  name?: Maybe<StringQueryOperatorInput>;
  path?: Maybe<StringQueryOperatorInput>;
...
export type SeoTypeQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'description' | 'author' | 'url' | 'image'>> }> };

export type IndexPageTypeQueryVariables = {};
