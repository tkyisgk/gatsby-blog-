...
const Facebook = ({ iconColor, bgColor }) => (
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 195 195.1">
    <g>
      ...
      <path fill={iconColor} class="cls-1" d="M135.4,125.7l4.3-28.2H112.6V79.2c0-7.7,3.9-15.3,16-15.3h12.2V40.1A135,135,0,0,0,119.1,38C96.8,38,82.4,51.6,82.4,76V97.5H57.5v28.2H82.4v68.2a96.87,96.87,0,0,0,30.4,0V125.7Z" />
    </g>
  </svg>
